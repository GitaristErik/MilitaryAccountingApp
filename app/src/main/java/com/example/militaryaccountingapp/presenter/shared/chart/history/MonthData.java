...
public final class MonthData extends ChartData {
    ...
    public void createMonthsArray() {
        ...
        for (int i = 0; i < days.size() - 1; i++) {
            ...
            if (i == days.size() - 2) {
                if (todayDate.getMonthValue() == nextDate.getMonthValue() &&
                    ...
                    totalItems += days.get(i + 1).getItems();

                    months.add(HistoryChartItem.of(nextDate, totalItems));
                }
        ...
        if (days.size() == 1) {
            months.add(HistoryChartItem.of(days.get(0).getDate(), days.get(0).getItems()));
        }
    }
}
